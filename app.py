...
def get_missing_keywords(resume_text, job_description):
    stop_words = set(
        ['and', 'the', 'is', 'in', 'at', 'of', 'a', 'to', 'for', 'with', 'on', 'by', 'an', 'be', 'it', 'this', 'that',
         'are', 'from', 'or', 'as', 'but', 'not', 'can', 'will', 'has', 'have', 'job', 'description', 'role', 'work',
         'experience', 'candidate', 'skills', 'we', 'you', 'your', 'team', 'responsibilities', 'requirements',
         'qualifications'])
